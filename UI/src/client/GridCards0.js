...
export default function GridCards() {
  ...
  const [clientData, setClientData] = useState({"data":initializeData,"latest_update_time": 0,"previous_update_time": 0});
  var refresh = false;
  ...
  useEffect(() => {
    ...
    if(source){
        ...
        newdata = clientData["data"].map(function(item){
          ...
          //Key detection line
          var found = serverData.find(src => src.object_name === item.object_name);
            ...
            <Card className={classes.card} >
                <CardHeader
                   avatar={
                     <Avatar aria-label="recipe" className={classes.avatar}>
                       {tile.object_name.charAt(0).toUpperCase()}
                     </Avatar>
                   }
                   action={
                ...
                <CardActionArea style={{backgroundColor: tile.last_statusColor}}>
                  <CardMedia
                    ...
                    image={tile.object_img}
                    title="Demo image"
                  />
                  <CardContent>
                    <Typography gutterBottom variant="h5" component="h2">
                      {tile.object_name} - {tile.title}
                    </Typography>
